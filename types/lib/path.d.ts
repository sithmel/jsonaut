...
export function areSegmentsEqual(
  segment1: JSONSegmentPathEncodedType | null,
  segment2: JSONSegmentPathEncodedType | null,
): boolean
/**
 *
 ...
 */
export function toEncodedSegment(
  pathSegment: JSONSegmentPathType,
): JSONSegmentPathEncodedType
/**
 *
