 ...
 */
export function fromEndToIndex<T>(array: Array<T>, index: number): Iterable<[number, T]>;
/**
 ...
 * @returns {Iterable<[number, T]>}
 */
export function fromIndexToEnd<T>(array: Array<T>, index: number): Iterable<[number, T]>;
/**
 * "}" or "]"
 * @private
