 ...
 */
export default function includes<T extends [Path, Value] | [Path, Value, number, number]>(asyncIterable: AsyncIterable<Iterable<T>>, includes: string | MatcherContainer): AsyncIterable<Iterable<T>>;
